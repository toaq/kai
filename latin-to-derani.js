...
const MATRIX_SUBORDINATORS = ["ꝡa", "ma", "tıo"],
      ...
      ILLOCUTIONS = [].concat(FALLING_TONE_ILLOCUTIONS, RAISING_TONE_ILLOCUTIONS, PEAKING_TONE_ILLOCUTIONS),
      ...
      FUNCTORS_WITH_GRAMMATICAL_TONE = [].concat(PREDICATIZERS, ["mı", "shu", "mo"]);
